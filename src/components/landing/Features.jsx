                    ...
                    <div className="max-w-2xl text-center lg:text-left">
                        <FadeContent blur duration={600}>
                            ...
                            >
                                ...
                                <span className="text-sm font-black tracking-[0.2em] text-primary-600 uppercase">
                                    <ShinyText text="Premium Features" speed={4} className="text-primary-600" />
                                </span>
                            </motion.div>
                        </FadeContent>
                    ...
                    {features.map((feature, index) => {
                        ...
                        return (
                            <FadeContent key={index} blur duration={600} delay={index * 100}>
                                <SpotlightCard
                                    className="group relative p-10 bg-white rounded-[3rem] border border-slate-100 hover:border-primary-100 hover:shadow-[0_30px_60px_rgba(0,0,0,0.05)] transition-all duration-500 flex flex-col items-start h-full"
